...
public interface ArticleRepository extends JpaRepository<Article,Long>{
	...
	// test
	@Modifying
	@Query("update Article A set A.desription = :d A.desription = :d and  where A.id == :i")
	public void testUpdateArticle(@Param("i") int id, @Param("d") String description, @Param("b") String brand, @Param("p") double price, @Param("c") int category);
